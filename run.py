...
Examples:
  ...
  %(prog)s validate --dry-run     # Validate without side effects
    ...
    demo_parser.add_argument('--output', '-o', default='artifacts/demo_report.json',
    ...
    validate_parser.add_argument('--dry-run', action='store_true',
                                help='Validate without creating files')
    validate_parser.add_argument('--output', '-o', default='artifacts/validation_report.json',
                                help='Output file path')
